            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div class="fade-in-up">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="#reserva" class="border-2 border-red-600 text-red-600 px-8 py-3 rounded-full font-medium hover:bg-red-50 transition-colors duration-300">
                            Reservar Mesa
                        </a>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="pizza-card bg-white rounded-lg overflow-hidden shadow-lg">
                    <img src="../img/pizza2.jpg" alt="Margherita" class="w-full h-48 object-cover">
                    <div class="p-6">
                        <h3 class="text-xl font-semibold mb-2">Pizza Margherita</h3>
                        <p class="text-gray-600 mb-4">Salsa de tomate, mozzarella fresca, albahaca</p>
